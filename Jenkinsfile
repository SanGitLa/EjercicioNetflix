            ...
            steps {
                dir("ZuulBase/"){
                    withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'docker_hub', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
                        ...
                        sh "docker build -t ss1977/zuul:latest ."
                        ...
                        sh 'docker push ss1977/zuul:latest'
                    }
                }
            }
        }
        ...
        stage('Eureka') {
            ...
            steps {
                dir("EurekaBase/"){
                    withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'docker_hub', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
                        sh 'docker login -u $USERNAME -p $PASSWORD'
                        sh "docker build -t ss1977/eureka:latest ."
                        ...
                        sh 'docker push ss1977/eureka:latest'
                    }
                }
            }
        }
        ...
        stage('Ordenes') {
            ...
            steps {
                dir("ordenes-service/"){
                    withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'docker_hub', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
                        sh 'docker login -u $USERNAME -p $PASSWORD'
                        sh "docker build -t ss1977/ordenes-service:latest ."
                        ...
                        sh 'docker push ss1977/ordenes-service:latest'
                    }
                }
            }
        }
        ...
        stage('Productos') {
            ...
            steps {
                dir("productos-service/"){
                    withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'docker_hub', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
                        sh 'docker login -u $USERNAME -p $PASSWORD'
                        sh "docker build -t ss1977/productos-service:latest ."
                        ...
                        sh 'docker push ss1977/productos-service:latest'
                    }
                }
            }
        }
        ...
        stage('Usuarios') {
            ...
            steps {
                dir("usuarios-service/"){
                    withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'docker_hub', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
                        sh 'docker login -u $USERNAME -p $PASSWORD'
                        sh "docker build -t ss1977/usuarios-service:latest ."
                        ...
                        sh 'docker push ss1977/usuarios-service:latest'
                    }
                }
            }
        }
